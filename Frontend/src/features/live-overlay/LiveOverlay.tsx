...
//             className="text-xs bg-amber-600/20 hover:bg-amber-600/40 text-amber-300 border border-amber-500/40 px-3 py-1.5 rounded-lg transition font-medium"
//           >
//             ⚙ DM Controls
//           </button>
//         </header>
