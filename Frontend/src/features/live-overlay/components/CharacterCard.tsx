...
//   // קריאה ל-Service דרך ה-Hook המקורי שלך (כל 5 שניות בלייב)
//   const { character: liveCharacter, loading, error } = useDndCharacter(
//     initialCharacter.dndCharacterId || '',
//     5000
//   );

//   // אם יש נתונים מ-D&D Beyond נשתמש בהם, אחרת בנתונים הסטטיים ההתחלתיים
...
//             )}
//           </div>
//           <span className="absolute -bottom-2 -right-2 bg-indigo-600 text-white text-xs font-bold px-2 py-0.5 rounded-md shadow">
...
//       <div className="grid grid-cols-6 gap-1 px-4 py-3 text-center bg-slate-900">
//         {[
...
//         className="mt-auto w-full py-2 px-4 bg-slate-800/50 hover:bg-slate-800 text-xs text-indigo-300 font-semibold flex items-center justify-center gap-1.5 border-t border-slate-800 transition-colors"
//       >
